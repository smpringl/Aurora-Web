      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-3">
            <Button variant="ghost" className="font-medium text-gray-500 hover:text-black hover:bg-transparent" asChild>
              <Link to="/auth?mode=signin">Log In</Link>
            </Button>
            <Button className="bg-black text-white hover:bg-gray-800 font-medium rounded-full px-6" asChild>
          ...
          <div className="md:hidden py-4 border-t border-gray-200">
            <nav className="flex flex-col space-y-3">
              ...
              <div className="flex flex-col space-y-2 pt-4 border-t border-gray-200">
                ...
                <Button className="w-full bg-black text-white hover:bg-gray-800 font-medium rounded-full" asChild>
